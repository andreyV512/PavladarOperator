...
__published:	// IDE-managed Components
	...
	TADOQuery *queryVirt;
	TADOQuery *queryQuick;
	TADOQuery *queryForChart;
...
public:		// User declarations
	...
	int FillComboBox(AnsiString _tableName, AnsiString _fieldName,AnsiString _where,TComboBox* _comboBox);
    ...
    int UpdBoolSql(AnsiString _tableName, AnsiString _fieldName, bool _fieldValue, AnsiString _where);
	...
	AnsiString GetStrFromFunctionSql(AnsiString _strSql, int &_err);
	double GetDoubleFromFunctionSql(AnsiString _strSql, int &_err);
};
//---------------------------------------------------------------------------
